...
set_property PACKAGE_PIN N11 [get_ports COM_SPICLK]
set_property IOSTANDARD LVTTL [get_ports COM_SPICLK]

set_property PACKAGE_PIN N12 [get_ports COM_SPICS]
set_property IOSTANDARD LVTTL [get_ports COM_SPICS]

set_property PACKAGE_PIN P10 [get_ports COM_SPIIN]
set_property IOSTANDARD LVTTL [get_ports COM_SPIIN]

set_property PACKAGE_PIN P11 [get_ports COM_SPIOUT]
